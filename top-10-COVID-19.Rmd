...
barplot(new_cases ~state,data=df_cases,main="Top 5 States Ranked by single Day Cases",xlab="Weekly Date",ylab="Cases")
grid(col="black")
...
barplot(new_deaths ~state,data=df_deaths,main="Top 5 States Rankded by Daily Deaths",xlab="Weekly Date",ylab="Cases")
grid(col="black")
```
